...
import minitest.impl.ClassroomManage;
import minitest.impl.StudentManage;
...
public class MainTest {
    ...
    private static void subMenu(StudentManage studentManage, Scanner scanner) throws IOException {
        int choice = -1;
        do {
            System.out.println("MENU");
